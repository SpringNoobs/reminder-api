...
public class JobService {
    ...
    private static final String REINDER_TRIGGER_NAME = "reminder-trigger";
    private static final String REINDER_JOB_NAME = "reminder-job";
    private static final String REINDER_JOB_GROUP = "reminders";
    ...
    public void scheduleJob(Reminder reminder) throws SchedulerException {
        ...
        JobDetail jobDetail = JobBuilder.newJob(ReminderJob.class)
                .withIdentity(REINDER_JOB_NAME + "-" + reminder.getId(), REINDER_JOB_GROUP)
    ...
    public void deleteReminderSchedules(Long reminderId) throws SchedulerException {
        JobKey jobKey = new JobKey(REINDER_JOB_NAME + "-" + reminderId, REINDER_JOB_GROUP);
    ...
    private void scheduleTrigger(Reminder reminder, String suffix, Instant fireTime) throws SchedulerException {
        ...
        Trigger trigger = TriggerBuilder.newTrigger()
                .withIdentity(REINDER_TRIGGER_NAME + "-" + reminder.getId() + "-" + suffix, REINDER_JOB_GROUP)
                .forJob(REINDER_JOB_NAME + "-" + reminder.getId(), REINDER_JOB_GROUP)
